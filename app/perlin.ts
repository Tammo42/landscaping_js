...
const p : number[] = [151, 160, 137, 91, 90, 15,131, 13, 201, 95, 96, 53, 194,
...
export function noise3D(x : number, y : number, z : number) : number {
    const xf : number = Math.floor(x);
    const yf : number = Math.floor(y);
    const zf : number = Math.floor(z);
...
export function noise1D(x : number) : number {return noise2D(x, 0);}